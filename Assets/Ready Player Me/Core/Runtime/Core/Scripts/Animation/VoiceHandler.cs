...
namespace ReadyPlayerMe.Core
{
    ...
    public class VoiceHandler : MonoBehaviour
    {
        ...
        private bool CanGetAmplitude => AudioSource != null && AudioSource.clip != null && AudioSource.isPlaying && AudioSource.clip.samples-AUDIO_SAMPLE_LENGTH > AudioSource.timeSamples;
